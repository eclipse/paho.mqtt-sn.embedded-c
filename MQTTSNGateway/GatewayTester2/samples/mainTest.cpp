 ...
 *------------------------------------------------------*/
UDPCONF = { "GWTestClient-2",  // ClientId
 ...
 *------------------------------------------------------*/
UDP6CONF = { "GWTestClient-2",  // ClientId
 ...
 *------------------------------------------------------*/
RFCOMMCONF = { "GWTestClient-2",      // ClientId
 ...
 *     Define Topics
 *------------------------------------------------------*/
const char* gwt1willtopic = "gwt1/willtopic";
 ...
 *------------------------------------------------------*/
int on_Gwt1willtopic(uint8_t* pload, uint16_t ploadlen)
{
	DISPLAY("\n\ngwt1willtopic recv.\n");
...
{   // e.g. SUB(TopicType, topicName, TopicId, callback, QoSx),
	SUB(MQTTSN_TOPIC_TYPE_NORMAL, gwt1willtopic, 0, on_Gwt1willtopic, QoS0),
